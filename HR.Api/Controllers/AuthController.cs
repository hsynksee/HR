...
namespace HR.Api.Controllers
{
    ...
    public class AuthController : BaseController
    {
        ...
        public AuthController(IAuthService authService, IUserService userService, IAppSettings appSettings, ISystemAppService systemAppService) : base(systemAppService)
        {
